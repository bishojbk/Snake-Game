...
let highScoreCard = document.querySelector(".high-score");
...
const handleGameOver = () => {
  ...
  alert("Game Over. Click Ok if you want to continue.");
  location.reload();
};
...
const initGame = () => {
  ...
  for (let i = 0; i < snakeBody.length; i++) {
    template += `<div class="snake" style="grid-area:${snakeBody[i][1]}/${snakeBody[i][0]}"></div>`;
    if (
      i !== 0 &&
  ...
  playingBoard.innerHTML = template;
};
